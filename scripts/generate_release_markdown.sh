...
#### Mac
$(print_link "${BASE_URL}/wau-chat-desktop-${VERSION}-mac.dmg")
...
$(print_link "${BASE_URL}/wau-chat-desktop-${VERSION}-linux-i386.AppImage")
$(print_link "${BASE_URL}/wau-chat-desktop-${VERSION}-linux-x86_64.AppImage")
MD
